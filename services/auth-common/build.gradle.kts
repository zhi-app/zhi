...
val firebaseApi by configurations

dependencies {
    api(project(":common"))
    firebaseApi(project(":common-firebase"))
    firebaseApi(Config.firebaseAuth)
    firebaseApi(Config.gmsAuth)
//    firebaseApi(Config.gmsTasks)
//    firebaseApi(Config.gmsBase)
//    firebaseApi(Config.gmsBasement)
