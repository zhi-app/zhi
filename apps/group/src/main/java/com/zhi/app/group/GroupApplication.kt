...
class GroupApplication : BaseApplication() {

    override fun applicationInjector(): AndroidInjector<out Application> {
        return DaggerGroupApplicationComponent.builder().application(this).build()
    }
}
...
interface GroupApplicationComponent : AndroidInjector<GroupApplication> {
    ...
    interface Builder {
        ...
        fun build(): GroupApplicationComponent
    }
}